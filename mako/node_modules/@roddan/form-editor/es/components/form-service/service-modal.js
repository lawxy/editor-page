...
var ServiceModal = function ServiceModal(_ref) {
  ...
  var methodOptions = RequestMethod.map(function (item) {
    return {
      label: item,
      value: item
    };
  });
  var getDefaultService = function getDefaultService(serv) {
    if (serv !== null && serv !== void 0 && serv.id) return serv;
    return {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.isValidElement(children) && /*#__PURE__*/React.cloneElement(children, {
    ...
    onOk: /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 2:
            serviceValue = form.getFieldsValue();
            if (service) {
    ...
    footer: function footer(_, _ref3) {
      var OkBtn = _ref3.OkBtn,
        CancelBtn = _ref3.CancelBtn;
      return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(CancelBtn, null), /*#__PURE__*/React.createElement(Preview, {
        form: form
      }, /*#__PURE__*/React.createElement(Button, null, "\u9884\u89C8")), /*#__PURE__*/React.createElement(OkBtn, null));
    }
    ...
    rules: [{
      ...
      validator: function validator(_, val) {
        if (val.match(/^https?:\/\/((localhost:\d{1,5})|([\w\-_]+(\.[\w\-_]+)+))([\w\-.,@?^=%&amp;:/~+#]*[\w\-@?^=%&amp;/~+#])?$/)) {
    ...
    }, /*#__PURE__*/React.createElement("span", null, "\u62E6\u622A\u5668\u8BBE\u7F6E"), /*#__PURE__*/React.createElement(AttributesSetting, {
      title: "\u62E6\u622A\u5668\u8BBE\u7F6E",
    ...
    label: /*#__PURE__*/React.createElement(Flex, {
      ...
      justify: "space-between"
    }, /*#__PURE__*/React.createElement("span", null, "\u9884\u89C8\u53C2\u6570"), /*#__PURE__*/React.createElement(AttributesSetting, {
      title: "\u7F16\u8F91\u53C2\u6570",
      editorType: "javascript",
      value: form.getFieldValue('previewData') || 'export default {\n\t\n}',
      onChange: function onChange(v) {
