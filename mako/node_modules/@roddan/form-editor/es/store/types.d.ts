...
import type { IBaseElement, IFormAttributesProps, TFormSerive, TFormSerives } from '../types';
export interface IElementStore {
    ...
    dfsEl: (el: IBaseElement, callback: (el: IBaseElement) => void, containParent?: boolean) => void;
    ...
    setElementProp: <T extends keyof IBaseElement>(id: string, field: T, value: IBaseElement[T]) => void;
    setSelectedProp: <T extends keyof IBaseElement>(field: T, value: IBaseElement[T]) => void;
}
...
export interface IFormAttrStore {
    ...
    setFormAttr: <T extends keyof IFormAttributesProps>(key: T, value: IFormAttributesProps[T]) => void;
}
...
export interface IBaseStore extends IServiceStore, IElementStore, IFormAttrStore, IFieldValuesStore {
    getFormJson: () => {
        formElements: IBaseElement[];
        fieldValues: Record<string, any>;
        formAttrs: IFormAttributesProps;
